...
#
# Thanks to Akashi, for this awesome module !!
#
...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Reply To A Photo Or Sticker!`")
        return
    ...
    if photo:
        ...
        if guess and imgspage:
            ...
            await img.edit("`Unable To Search!`")
            return
